 ...
 */
static char *font = "MxPlusToshibaSat8x14:style=Regular:size=12:antialias=true:autohint=true";
/* Spare fonts */
static char *font2[] = {
	"JetBrainsMonoNerdFont:style=Regular:size=12:antialias=true"
};
...
static const char *colorname[] = {
	/* 8 normal colors - based on your .Xresources */
	"#04000f",  /* black */
	"#a51723",  /* red */
	"#00822f",  /* green */
	"#f95c22",  /* yellow */
	...
	"#e51919",  /* bright red */
	"#41ea41",  /* bright green */
	"#f9d222",  /* bright yellow */
	"#0e6bb7",  /* bright blue */
	"#ea7cc4",  /* bright magenta */
	"#7dbbff",  /* bright cyan */
	"#eff9ff",  /* bright white */
 ...
 * 7: Snowman ("☃")
 */
#define cursorstyle cursorshape
